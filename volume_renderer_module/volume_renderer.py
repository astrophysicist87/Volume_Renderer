...
def render_volume(points, datacube, angles, **kwargs):
    ...
    if use_log_densities:
        ...
        for dataslice in camera_grid:
            ...
            r,g,b,a = transferFunction(normed_log_dataslice, cutoff=normed_log_cutoff, frac=2.0*normed_log_cutoff)
        ...
        for dataslice in camera_grid:
            ...
            r,g,b,a = transferFunction(normed_dataslice, cutoff=normed_cutoff, frac=2.0*normed_cutoff)
            image[:,:,0] = a*r + (1-a)*image[:,:,0]
            image[:,:,1] = a*g + (1-a)*image[:,:,1]
            image[:,:,2] = a*b + (1-a)*image[:,:,2]
